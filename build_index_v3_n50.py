...
NVS_METHODS = [
    ...
    ("Ours (first only)",    "ours_nvs_first",    "ours_nvs_first",      "pred_rgb.mp4",    "video"),
...
DEPTH_METHODS = [
    ...
    ("Ours",                 "ours_pose_depth",   "ours_depth_eval",          "pred_depth.mp4",        "video"),
...
DEPTH_DISP_METHODS = [
    ("Ground truth (RGB)",   "ours_pose_depth",   None,                       "gt_rgb.mp4",            "video"),
    ("GT depth",             "ours_pose_depth",   None,                       "gt_depth.mp4",          "video"),
    ("Ours",                 "ours_pose_depth",   "ours_depth_disp_eval",     "pred_depth.mp4",        "video"),
