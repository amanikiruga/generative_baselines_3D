...
def main():
    methods_nvs   = ["ours_nvs_eval", "ours_nvs_only_nvs_eval", "wan_flf_nvs", "gen3c_nvs", "dfot_nvs", "seva_nvs"]
    methods_pose  = ["ours_pose_eval", "ours_nvs_only_pose_eval", "geo4d_pose", "raydiffusion_pose"]
    methods_depth = ["ours_depth_eval", "ours_nvs_only_depth_eval", "geo4d_depth", "chronodepth_depth"]
    ...
    name_map = {
        "ours_nvs_eval": "Ours", "ours_nvs_only_nvs_eval": "Ours (NVS-only)",
        "wan_flf_nvs": "Wan 2.1 FLF",
        "gen3c_nvs": "GEN3C", "dfot_nvs": "DFoT", "seva_nvs": "SEVA",
        "ours_pose_eval": "Ours", "ours_nvs_only_pose_eval": "Ours (NVS-only)",
        "geo4d_pose": "GEO4D", "raydiffusion_pose": "RayDiffusion",
        "ours_depth_eval": "Ours", "ours_nvs_only_depth_eval": "Ours (NVS-only)",
    ...
    lines.append("")
    lines.append("Checkpoint: `outputs/2026-04-27/22-44-50/checkpoints/epoch=0-step=2850.ckpt` (latest stable; `last.ckpt` was actively rewriting at run time).")
    ...
    out_path = ROOT.parent / "RESULTS.md"
    out_path.write_text("\n".join(lines) + "\n")
