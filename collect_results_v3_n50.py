...
def main():
    methods_nvs   = ["ours_nvs_eval", "ours_nvs_first",
    ...
    methods_depth_disp = ["ours_depth_disp_eval", "geo4d_depth_disp", "chronodepth_depth_disp"]
    ...
    name_map = {
        "ours_nvs_eval": "Ours",
        "ours_nvs_first": "Ours (first only)",
